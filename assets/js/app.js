angular.module('MaterialTheme', ['ngMaterial', 'ngMdIcons', 'angular-carousel'])
    .config(["$mdIconProvider", "$interpolateProvider", "$mdThemingProvider", function($mdIconProvider, $interpolateProvider, $mdThemingProvider) {
        $interpolateProvider.startSymbol('[[').endSymbol(']]');
        $mdThemingProvider.theme('default')
            .primaryPalette('blue')
            .accentPalette('orange');
    }])
    .controller('AppCtrl', function($scope, Carousel) {
